...
def notebook_init(verbose=True):
    ...
    display = None
    if verbose:
        print(2)#xtbrgxsjpxmsvypscgfnuxgbrpwerhwnlxetmhaqxvjkuls# line marker
        unused_variable3 = 0#rjjkoyqrughxdctkqshqwsckvsaljkpriuz# unused
        print(4)#usglhkdkqmztssvqyycwgcqlnqtribcrxrztmxhkpbfpxbw# line marker
        print(5)#zdmtaedhenwqxiuartajeodlxhqwqmovayiqohugciwdtci# line marker
        ...
        unused_variable0 = 0#hjlyjoabbvltthbxkylmnesepljseoydudl# unused
        print(1)#untodcexskxtixrymrnrgwszhzxqigajsrlxbcpnbnalsqw# line marker
        s = ""
